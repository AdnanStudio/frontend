          ...
          <div className="about-content">
            ...
            <div className="about-text">
              <p className="about-intro about-large-text">
                ...
                ২০০২ সালে সরকারি স্বীকৃতি লাভ করে। এটি অনার্স পর্যায়ে অনুমোদিত
                একটি শিক্ষা প্রতিষ্ঠান এবং এমপিওভুক্ত, যার এমপিও রেজিস্ট্রেশন নম্বর
                ২৯০৪১২৩১০১ । কলেজটি ঢাকা বোর্ডের অধীনে পরিচালিত হয়। এখানে বিজ্ঞান,
          ...
          <div className="message-content">
            <div className="message-text">
              ...
              <p className="message-large-text">
                অধ্যক্ষের বাণী :<br /> <br />
                মালখানগর কলেজ জ্ঞান, মূল্যবোধ ও আধুনিক শিক্ষার সমন্বয়ে একটি
                অগ্রসরমান প্রতিষ্ঠান। আমরা শিক্ষার্থীদের মেধা, দক্ষতা ও চরিত্র গঠনে
                প্রতিশ্রুতিবদ্ধ। প্রিয় শিক্ষার্থীরা—স্বপ্ন দেখো, শিখো এবং
                নৈতিকতা ও অধ্যবসায়ের সাথে এগিয়ে চলো। তোমাদের প্রতিটি অগ্রযাত্রায়
                মালখানগর কলেজ সর্বদা পাশে রয়েছে।
              </p>
            </div>
