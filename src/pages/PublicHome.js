                ...
                <div className="about-content">
                  ...
                  <div className="about-text">
                    <p className="about-intro about-large-text">
                      ...
                      মন্ত্রণালয়ের অধীন মাধ্যমিক ও উচ্চশিক্ষা অধিদপ্তর প্রদত্ত
                      EIIN নম্বর ১৩৪৫৯০ বহন করে। প্রতিষ্ঠানটি ১ জুলাই ১৯৯২
                      সালে প্রতিষ্ঠিত হয় এবং ১ জুলাই ২০০২ সালে সরকারি স্বীকৃতি
                      লাভ করে।
                    </p>
                  ...
                  <div className="message-content">
                    <div className="message-text">
                      <p className="message-large-text">
                        মালখানগর কলেজ জ্ঞান, মূল্যবোধ ও আধুনিক শিক্ষার সমন্বয়ে
                        একটি অগ্রসরমান প্রতিষ্ঠান। আমরা শিক্ষার্থীদের মেধা,
                        দক্ষতা ও চরিত্র গঠনে প্রতিশ্রুতিবদ্ধ।
                      </p>
                    </div>
